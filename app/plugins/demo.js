...
bun run build`),H=t(`<div class="h-full overflow-auto p-6"><h1 class="text-2xl font-bold mb-6">Create a Layout</h1><p class="text-base-content/70 mb-8">Layouts define the structure of your application. They use the <code class="bg-base-300 px-1 rounded">use</code> prop to inject plugin components.</p><div class=space-y-8><section><h2 class="text-lg font-semibold mb-3 flex items-center gap-2"><span class="badge badge-primary">1</span>Create a layout component</h2><pre class="bg-base-300 p-4 rounded-lg text-sm overflow-x-auto"><code>// src/layouts/MyLayout.jsx
...
});</code></pre></section><section><h2 class="text-lg font-semibold mb-3 flex items-center gap-2"><span class="badge badge-primary">5</span>Build</h2><pre class="bg-base-300 p-4 rounded-lg text-sm overflow-x-auto"><code>webarcade build my-plugin</code></pre><p class="text-sm text-base-content/70 mt-3">This compiles the Rust backend and bundles the JS frontend.`),j=t('<div class="h-full overflow-auto p-6"><h1 class="text-2xl font-bold mb-6">Hot Reload</h1><div class="space-y-6 max-w-2xl"><p class=text-base-content/70>WebArcade includes a built-in hot reload dev server that watches for changes and automatically rebuilds and refreshes.</p><section class="bg-base-200 rounded-lg p-4"><h2 class="font-bold mb-3">How it works</h2><ul class="list-disc list-inside space-y-2 text-sm text-base-content/70"><li><code class=text-primary>src/</code> changes → Frontend rebuilds → Browser refreshes</li><li><code class=text-primary>plugins/</code> changes → Plugin rebuilds → Browser refreshes</li><li><code class=text-primary>app/plugins/</code> changes → Browser refreshes</li></ul></section><section class="bg-base-200 rounded-lg p-4"><h2 class="font-bold mb-3">Start dev mode</h2><pre class="bg-base-300 p-4 rounded-lg text-sm overflow-x-auto"><code>webarcade run</code></pre><p class="text-sm text-base-content/70 mt-3">This starts the dev server with file watching and hot reload enabled.</p></section><section class="bg-base-200 rounded-lg p-4"><h2 class="font-bold mb-3">WebSocket</h2><p class="text-sm text-base-content/70">The dev server uses a WebSocket on port <code class=text-primary>3002</code> to signal the browser to reload when files change.'),_=t('<div class="h-full bg-base-100">'),[B,D]=g("welcome"),I=[{id:"welcome",label:"Welcome",icon:S},{id:"components",label:"UI Components",icon:P},{id:"plugin-tutorial",label:"Create a Plugin",icon:M},{id:"layout-tutorial",label:"Create a Layout",icon:k},{id:"backend-tutorial",label:"Backend Plugins",icon:A},{id:"hot-reload",label:"Hot Reload",icon:M}];function N(){var e;return s((e=R()).firstChild.nextSibling,a(h,{each:I,children:e=>{var t,o;return o=(t=T()).firstChild,t.$$click=()=>D(e.id),s(t,a(e.icon,{size:16}),o),s(o,()=>e.label),n(()=>l(t,`w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-colors ${B()===e.id?"bg-primary text-primary-content":"hover:bg-base-300"}`)),t}})),e}function O(){var e,t,n,l,o;return n=(t=(e=E()).firstChild.firstChild.nextSibling.nextSibling.firstChild).firstChild,o=(l=t.nextSibling).firstChild,s(t,a(S,{size:18}),n),s(l,a(C,{size:18}),o),e}function V(){var e,t,a,l,o,r,i,c,d,p,u;let[b,m]=g(0),[h,f]=g(!1),[x,y]=g(50);return r=(o=(l=(a=(t=(e=z()).firstChild.nextSibling.nextSibling.firstChild.nextSibling.nextSibling).firstChild.nextSibling.firstChild).firstChild).nextSibling).nextSibling,c=(i=a.nextSibling).firstChild,d=i.nextSibling.firstChild,(p=t.nextSibling.firstChild).firstChild,u=p.nextSibling,l.$$click=()=>m(e=>e-1),s(o,b),r.$$click=()=>m(e=>e+1),c.addEventListener("change",e=>f(e.target.checked)),d.addEventListener("change",e=>f(e.target.checked)),s(p,x,null),u.$$input=e=>y(parseInt(e.target.value)),n(()=>c.checked=h()),n(()=>d.checked=h()),n(()=>u.value=x()),e}function G(){return L()}function q(){return H()}function $(){return W()}function F(){return j()}function U(){var e;return s(e=_(),a(m,{get when(){return"welcome"===B()},get children(){return a(O,{})}}),null),s(e,a(m,{get when(){return"components"===B()},get children(){return a(V,{})}}),null),s(e,a(m,{get when(){return"plugin-tutorial"===B()},get children(){return a(G,{})}}),null),s(e,a(m,{get when(){return"layout-tutorial"===B()},get children(){return a(q,{})}}),null),s(e,a(m,{get when(){return"backend-tutorial"===B()},get children(){return a($,{})}}),null),s(e,a(m,{get when(){return"hot-reload"===B()},get children(){return a(F,{})}}),null),e}var J=u({id:"demo",name:"Welcome",version:"1.0.0",description:"Welcome screen and tutorials for WebArcade",author:"WebArcade",start(e){e.register("sidebar",{type:"panel",component:N,label:"Navigation"}),e.register("content",{type:"panel",component:U,label:"Content"}),e.register("help-menu",{type:"menu",label:"Help",order:100,submenu:[{label:"Documentation",action:()=>window.open("https://warcade.github.io/docs/")},{label:"GitHub",action:()=>window.open("https://github.com/warcade/core")}]})},stop(){}});i(["click","input"]);export{J as default};