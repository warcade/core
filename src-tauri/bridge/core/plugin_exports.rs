...
pub static GLOBAL_ROUTER_REGISTRY: Lazy<Mutex<Option<crate::core::plugin_router::RouterRegistry>>> = Lazy::new(|| Mutex::new(None));
...
pub fn set_global_router_registry(registry: crate::core::plugin_router::RouterRegistry) {
    let mut global = GLOBAL_ROUTER_REGISTRY.lock().unwrap();
    *global = Some(registry);
}

/// Get a clone of the global router registry
pub fn get_global_router_registry() -> Option<crate::core::plugin_router::RouterRegistry> {
